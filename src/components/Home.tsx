...
export default function Home() {
    ...
    return (
        <div className="relative mx-auto py-4 w-full">
            ...
            <p className="mt-6 !leading-8 text-sm md:text-base">I’m a Web Developer and <span className="text-custom-purple relative ui-ux-design">UI/UX Designer</span>, dedicated to creating user-friendly and visually engaging digital experiences.<br />
