    ...
    return (
        <div className="relative mx-auto py-4 w-full">
            <nav className="w-full flex justify-between items-center relative">
                ...
                <div className="hidden md:flex gap-x-12 bg-secondary/10 p-4 rounded-2xl backdrop-blur-sm">
                    <div className="inline-flex items-center gap-x-4">
                        <Notepad2 size="32" color="#fff" /> <span className="active relative">About Me</span>
                    </div>
                    <div className="flex items-center gap-x-2">
                        <ShoppingBag size="32" color="#fff" /> <span className="relative">Experience</span>
                    </div>
                    <div className="flex items-center gap-x-2">
                        <Book1 size="32" color="#fff" /> <span className="relative">Education</span>
                    </div>
                </div>
            ...
            <div className="mt-16 w-full relative">
                <Icon3 className="w-16 md:w-18 lg:w-16 xl:w-20 absolute top-[16rem] -left-1 md:top-[10rem] md:-left-[4rem] xl:top-[8rem] xl:-left-[8rem]" />
                <Icon className="w-20 md:w-20 lg:w-18 xl:w-24 absolute -top-2 right-5 md:top-3 md:left-[16rem] xl:-top-2 xl:left-[18rem]" />
                <Icon2 className="w-20 md:w-24 lg:w-28 xl:w-30 absolute top-[17rem] -right-4 md:top-[14rem] xl:top-0 xl:right-1/3 z-0" />
            </div>
